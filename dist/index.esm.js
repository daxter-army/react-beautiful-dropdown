...
import React__default, { forwardRef, useContext, createElement, createContext, Fragment, createRef, useCallback, useEffect, useRef, useState } from 'react';
...
var DropdownItem = newStyled.li(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n\tpadding: 12px 8px;\n\tfont-size: 14px;\n\tline-height: 16px;\n\t", "\n\t", "\n\t", "\n\n\t&:not(:last-child) {\n\t\tborder-bottom: 1px #e7e7e7 solid;\n\t}\n"])), function (props) {
  ...
  return props.isActive && "background-color: #6ab04c; color: white; font-weight: 900;";
});
var Styled$1 = {
  Dropdown: Dropdown$1,
...
var Dropdown = function Dropdown(_ref) {
  var list = _ref.list,
    ...
    focusIndexHandler = _ref.focusIndexHandler,
    onClickItemHandler = _ref.onClickItemHandler,
    isMouseHoverAllowed = _ref.isMouseHoverAllowed,
    customDropdownStyles = _ref.customDropdownStyles,
    customDropdownItemStyles = _ref.customDropdownItemStyles,
    isMouseHoverAllowedHandler = _ref.isMouseHoverAllowedHandler;
  // Creating refs and assigning it to the elements
  var itemRefHandler = function itemRefHandler() {
    if (optionItemsRef.current.length <= list.length) {
      optionItemsRef.current.push( /*#__PURE__*/createRef());
    }
  };
  var onItemMouseEnterHandler = function onItemMouseEnterHandler(i) {
    focusIndexHandler(i);
  };
  var onDropdownMouseLeaveHandler = function onDropdownMouseLeaveHandler() {
    focusIndexHandler(-1);
  };
  var onDropdownMouseMoveHandler = function onDropdownMouseMoveHandler() {
    if (!isMouseHoverAllowed) {
      isMouseHoverAllowedHandler(true);
    }
  };
  var onClickDropdownHandler = function onClickDropdownHandler() {
    if (!isMouseHoverAllowed) {
      isMouseHoverAllowedHandler(true);
    }
  };
  return /*#__PURE__*/React__default.createElement(Styled$1.Dropdown, {
    ref: optionsRef,
    ...
    itemRefHandler();
    return /*#__PURE__*/React__default.createElement(Styled$1.DropdownItem, {
      key: item.id,
      ...
      onClick: function onClick() {
        return onClickItemHandler(item, i);
      },
      onMouseEnter: function onMouseEnter() {
        return onItemMouseEnterHandler(i);
      }
    }, item.label);
  }));
};
...
function useOutsideClick(ref, handler) {
  var refPresenceHandler = useCallback(function (event) {
...
function withKeyboardNavigation(WrappedComponent) {
  return function (props) {
    // To preserve previous value
    var cachedValueRef = useRef("");
    // To prevent bi-directional scroll updation, on value change
    var scrollLock = useRef(false);
    // Ref for input field
    ...
    var optionItemsRef = useRef([]);
    // To prevent mouse from interfering scroll updation
    var _useState7 = useState(true),
      _useState8 = _slicedToArray(_useState7, 2),
      isMouseHoverAllowed = _useState8[0],
      setIsMouseHoverAllowed = _useState8[1];
    ...
    var onClickItemHandler = function onClickItemHandler(item, idx) {
    ...
    var onKeyDownHandler = function onKeyDownHandler(e) {
      ...
      if (!optionsRef.current || !optionItemsRef.current) return;
      var dropdownScrollTop = (_a = optionsRef.current) === null || _a === void 0 ? void 0 : _a.scrollTop;
      var dropdownClientHeight = (_b = optionsRef.current) === null || _b === void 0 ? void 0 : _b.clientHeight;
      var dropdownScrollHeight = (_c = optionsRef.current) === null || _c === void 0 ? void 0 : _c.scrollHeight;
      var dropdownBottom = dropdownScrollTop + dropdownClientHeight;
      if (e.key.toLowerCase() === "arrowup") {
        // Do not update scroll when value changes from here
        scrollLock.current = true;
        // Pointer events none for the list
        setIsMouseHoverAllowed(false);
        var nextElement = (_d = optionItemsRef.current[focusIndex - 1]) === null || _d === void 0 ? void 0 : _d.current;
        var nextElementTop = nextElement === null || nextElement === void 0 ? void 0 : nextElement.offsetTop;
        if (focusIndex === 0 || focusIndex === -1) {
          (_e = optionsRef.current) === null || _e === void 0 ? void 0 : _e.scrollTo(0, dropdownScrollHeight);
          // Last index
          setFocusIndex(props.options.length - 1);
          props.valueHandler(props.options[props.options.length - 1].label);
          return;
        }
        var scrollDiff = dropdownBottom - nextElementTop;
        if (scrollDiff > dropdownClientHeight) {
          (_f = optionsRef.current) === null || _f === void 0 ? void 0 : _f.scrollBy(0, dropdownClientHeight - scrollDiff);
        }
        var operation = focusIndex === -1 ? activeIndex - 1 : focusIndex - 1;
        ...
        // Pointer events none for the list
        setIsMouseHoverAllowed(false);
        var _nextElement = (_g = optionItemsRef.current[focusIndex + 1]) === null || _g === void 0 ? void 0 : _g.current;
        var _nextElementTop = _nextElement === null || _nextElement === void 0 ? void 0 : _nextElement.offsetTop;
        var nextElementHeight = _nextElement === null || _nextElement === void 0 ? void 0 : _nextElement.clientHeight;
        var nextElementBottom = _nextElementTop + nextElementHeight;
        if (focusIndex === props.options.length - 1) {
          (_h = optionsRef.current) === null || _h === void 0 ? void 0 : _h.scrollTo(0, 0);
          setFocusIndex(0);
          props.valueHandler(props.options[0].label);
          return;
        }
        var _scrollDiff = nextElementBottom - dropdownScrollTop;
        if (_scrollDiff > dropdownClientHeight) {
          (_j = optionsRef.current) === null || _j === void 0 ? void 0 : _j.scrollBy(0, _scrollDiff - dropdownClientHeight);
        }
        var _operation = focusIndex === -1 ? activeIndex + 1 : focusIndex + 1;
        setFocusIndex(_operation);
        props.valueHandler(props.options[_operation].label);
        return;
        ...
        setIsActive(false);
        (_k = inputRef.current) === null || _k === void 0 ? void 0 : _k.blur();
        return;
      }
    ...
    useEffect(function () {
      ...
      var isIndexFound = valueMatcher(props.value, props.options);
    ...
    return /*#__PURE__*/React__default.createElement(WrappedComponent, Object.assign({
      inputRef: inputRef,
      isActive: isActive,
...
var Input = function Input(_ref) {
  var _ref$value = _ref.value,
    ...
    focusIndexHandler = _ref.focusIndexHandler,
    isMouseHoverAllowed = _ref.isMouseHoverAllowed,
    customInputStyles = _ref.customInputStyles,
    customDropdownStyles = _ref.customDropdownStyles,
    customDropdownItemStyles = _ref.customDropdownItemStyles,
    isMouseHoverAllowedHandler = _ref.isMouseHoverAllowedHandler,
  ...
  var dropdownRef = useRef([inputRef, optionsRef]);
  ...
  return /*#__PURE__*/React__default.createElement(Styled.InputWpr, null, /*#__PURE__*/React__default.createElement(Styled.InputCtr, null, /*#__PURE__*/React__default.createElement(Styled.Input, {
    value: value,
    ref: inputRef,
    isActive: isActive,
    onBlur: blurHandler,
  ...
  }), /*#__PURE__*/React__default.createElement(Styled.IconCtr, null, isActive ? /*#__PURE__*/React__default.createElement(FiChevronUp, {
    size: 18,
    color: isActive ? '#3498db' : "#777"
  }) : /*#__PURE__*/React__default.createElement(FiChevronDown, {
    size: 18,
    color: isActive ? '#3498db' : "#777"
  }))), error.isError && /*#__PURE__*/React__default.createElement(Styled.ErrorLabel, null, error.errorText, /*#__PURE__*/React__default.createElement(MdErrorOutline, null)), isActive && /*#__PURE__*/React__default.createElement(Dropdown, {
    list: options,
    optionsRef: optionsRef,
    focusIndex: focusIndex,
    activeIndex: activeIndex,
...
var ReactBeautifulDropdown = withKeyboardNavigation(Input);

export { ReactBeautifulDropdown as default };

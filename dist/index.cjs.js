...
var Dropdown = function Dropdown(_ref) {
  ...
  var itemRefHandler = function itemRefHandler() {
    if (optionItemsRef.current.length <= list.length) {
      optionItemsRef.current.push( /*#__PURE__*/React.createRef());
    }
  };
...
function useOutsideClick(ref, handler) {
  var refPresenceHandler = React.useCallback(function (event) {
...
function withKeyboardNavigation(WrappedComponent) {
  return function (props) {
    ...
    var cachedValueRef = React.useRef("");
    // To prevent bi-directional scroll updation, on value change
    var scrollLock = React.useRef(false);
    // Ref for input field
    ...
    var optionItemsRef = React.useRef([]);
...
module.exports = ReactBeautifulDropdown;
